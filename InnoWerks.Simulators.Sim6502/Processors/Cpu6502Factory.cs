    ...
    public static class Cpu6502Factory
    {
            ...
            Action<ICpu> postExecutionCallback)
        {
            return cpuClass switch
            {
                ...
                CpuClass.Synertek65C02 => new Cpu65C02(bus, preExecutionCallback, postExecutionCallback),
                CpuClass.Rockwell65C02 => new Cpu65C02(bus, preExecutionCallback, postExecutionCallback),
            ...
            Action<ICpu> postExecutionCallback) where T : Cpu6502Core
        {
            return cpuClass switch
            {
                ...
                CpuClass.Synertek65C02 => new Cpu65C02(bus, preExecutionCallback, postExecutionCallback) as T,
                CpuClass.Rockwell65C02 => new Cpu65C02(bus, preExecutionCallback, postExecutionCallback) as T,
