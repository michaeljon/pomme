...
{
    public static class OpCode65SC02
    {
        //
        ...
        // a) 1-cycle NOP on some older 65C02s
        // b) 1-cycle NOP on some older 65C02s
        // c) 1-cycle NOP on some older 65C02s
        // d) 1-cycle NOP on some older 65C02s
        ...
        public static readonly OpCodeDefinition[] Instructions =
        {
            ...
            new(0x07, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x0f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x17, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x1f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x27, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x2f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x37, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x3f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x47, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x4f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x57, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x5f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),

            new(0x60, OpCode.RTS, (cpu, addr, value) => cpu.RTS(addr, value), InstructionDecoders.DecodeStack, AddressingMode.Stack),
            new(0x61, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0x65, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x66, OpCode.ROR, (cpu, addr, value) => cpu.ROR(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x67, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x68, OpCode.PLA, (cpu, addr, value) => cpu.PLA(addr, value), InstructionDecoders.DecodeStack, AddressingMode.Stack),
            new(0x69, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x6d, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0x6e, OpCode.ROR, (cpu, addr, value) => cpu.ROR(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0x6f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),

            new(0x70, OpCode.BVS, (cpu, addr, value) => cpu.BVS(addr, value), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            new(0x71, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            new(0x72, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPageIndirect, AddressingMode.ZeroPageIndirect),
            ...
            new(0x75, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x77, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            new(0x78, OpCode.SEI, (cpu, addr, value) => cpu.SEI(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0x79, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0x7d, OpCode.ADC, (cpu, addr, value) => ((Cpu65SC02)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x7f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x87, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x8f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0x97, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x9f, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0xa7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xaf, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0xb7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0xbf, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0xc7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xcf, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
            ...
            new(0xd7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0xdf, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),

            new(0xe0, OpCode.CPX, (cpu, addr, value) => cpu.CPX(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            new(0xe1, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0xe5, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe6, OpCode.INC, (cpu, addr, value) => cpu.INC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe8, OpCode.INX, (cpu, addr, value) => cpu.INX(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xe9, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0xed, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xee, OpCode.INC, (cpu, addr, value) => cpu.INC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xef, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),

            new(0xf0, OpCode.BEQ, (cpu, addr, value) => cpu.BEQ(addr, value), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            new(0xf1, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            new(0xf2, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPageIndirect, AddressingMode.ZeroPageIndirect),
            ...
            new(0xf5, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0xf7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            new(0xf8, OpCode.SED, (cpu, addr, value) => cpu.SED(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xf9, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xfd, OpCode.SBC, (cpu, addr, value) => ((Cpu65SC02)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0xff, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.Relative),
        };
    }
}
