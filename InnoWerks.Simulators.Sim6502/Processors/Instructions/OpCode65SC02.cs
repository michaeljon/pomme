...
namespace InnoWerks.Simulators
{
    public static class OpCode65SC02
    {
        ...
        public static readonly OpCodeDefinition[] Instructions =
        {
            ...
            new(0x17, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x37, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x57, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x77, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x97, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xb7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xd7, OpCode.Unknown, (cpu, addr, value) => cpu.IllegalInstruction(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
