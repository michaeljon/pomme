...
{
    public static class OpCodeR65C02
    {
        //
        ...
        public static readonly OpCodeDefinition[] Instructions =
        {
            ...
            new(0x07, OpCode.RMB0, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 0), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x0f, OpCode.BBR0, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 0), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x17, OpCode.RMB1, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 1), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x1f, OpCode.BBR1, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 1), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x27, OpCode.RMB2, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 2), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x2f, OpCode.BBR2, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 2), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x37, OpCode.RMB3, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 3), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x3f, OpCode.BBR3, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 3), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x47, OpCode.RMB4, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 4), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x4f, OpCode.BBR4, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 4), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x57, OpCode.RMB5, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 5), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x5f, OpCode.BBR5, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 5), InstructionDecoders.DecodeRelative, AddressingMode.Relative),

            new(0x60, OpCode.RTS, (cpu, addr, value) => cpu.RTS(addr, value), InstructionDecoders.DecodeStack, AddressingMode.Stack),
            new(0x61, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0x65, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x66, OpCode.ROR, (cpu, addr, value) => cpu.ROR(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x67, OpCode.RMB6, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 6), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x68, OpCode.PLA, (cpu, addr, value) => cpu.PLA(addr, value), InstructionDecoders.DecodeStack, AddressingMode.Stack),
            new(0x69, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x6d, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0x6e, OpCode.ROR, (cpu, addr, value) => cpu.ROR(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0x6f, OpCode.BBR6, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 6), InstructionDecoders.DecodeRelative, AddressingMode.Relative),

            new(0x70, OpCode.BVS, (cpu, addr, value) => cpu.BVS(addr, value), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            new(0x71, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            new(0x72, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPageIndirect, AddressingMode.ZeroPageIndirect),
            ...
            new(0x75, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x77, OpCode.RMB7, (cpu, addr, value) => ((CpuR65C02)cpu).RMB(addr, value, bit: 7), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x78, OpCode.SEI, (cpu, addr, value) => cpu.SEI(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0x79, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0x7d, OpCode.ADC, (cpu, addr, value) => ((CpuR65C02)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x7f, OpCode.BBR7, (cpu, addr, value) => ((CpuR65C02)cpu).BBR(addr, value, bit: 7), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x87, OpCode.SMB0, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 0), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x8f, OpCode.BBS0, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 0), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0x97, OpCode.SMB1, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 1), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x9f, OpCode.BBS1, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 1), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0xa7, OpCode.SMB2, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 2), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xaf, OpCode.BBS2, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 2), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0xb7, OpCode.SMB3, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 3), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xbf, OpCode.BBS3, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 3), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0xc7, OpCode.SMB4, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 4), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xcf, OpCode.BBS4, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 4), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            ...
            new(0xd7, OpCode.SMB5, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 5), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xdf, OpCode.BBS5, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 5), InstructionDecoders.DecodeRelative, AddressingMode.Relative),

            new(0xe0, OpCode.CPX, (cpu, addr, value) => cpu.CPX(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            new(0xe1, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0xe5, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe6, OpCode.INC, (cpu, addr, value) => cpu.INC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe7, OpCode.SMB6, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 6), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe8, OpCode.INX, (cpu, addr, value) => cpu.INX(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xe9, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0xed, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xee, OpCode.INC, (cpu, addr, value) => cpu.INC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xef, OpCode.BBS6, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 6), InstructionDecoders.DecodeRelative, AddressingMode.Relative),

            new(0xf0, OpCode.BEQ, (cpu, addr, value) => cpu.BEQ(addr, value), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            new(0xf1, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            new(0xf2, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPageIndirect, AddressingMode.ZeroPageIndirect),
            ...
            new(0xf5, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0xf7, OpCode.SMB7, (cpu, addr, value) => ((CpuR65C02)cpu).SMB(addr, value, bit: 7), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xf8, OpCode.SED, (cpu, addr, value) => cpu.SED(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xf9, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xfd, OpCode.SBC, (cpu, addr, value) => ((CpuR65C02)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0xff, OpCode.BBS7, (cpu, addr, value) => ((CpuR65C02)cpu).BBS(addr, value, bit: 7), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
        };
    }
}
