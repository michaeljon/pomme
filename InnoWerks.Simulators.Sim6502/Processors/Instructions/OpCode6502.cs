...
namespace InnoWerks.Simulators
{
    public static class OpCode6502
    {
        ...
        public static readonly OpCodeDefinition[] Instructions =
        {
            ...
            new(0x03, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0x07, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x0b, OpCode.ANC, (cpu, addr, value) => ((Cpu6502)cpu).ANC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x0f, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            ...
            new(0x13, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0x17, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x1b, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0x1f, OpCode.SLO, (cpu, addr, value) => ((Cpu6502)cpu).SLO(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x23, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0x27, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x2b, OpCode.ANC, (cpu, addr, value) => ((Cpu6502)cpu).ANC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x2f, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            ...
            new(0x33, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0x37, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x3b, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0x3f, OpCode.RLA, (cpu, addr, value) => ((Cpu6502)cpu).RLA(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x43, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0x47, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x4b, OpCode.ALR, (cpu, addr, value) => ((Cpu6502)cpu).ALR(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x4f, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            ...
            new(0x53, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0x57, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x5b, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0x5f, OpCode.SRE, (cpu, addr, value) => ((Cpu6502)cpu).SRE(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),

            new(0x60, OpCode.RTS, (cpu, addr, value) => cpu.RTS(addr, value), InstructionDecoders.DecodeStack, AddressingMode.Stack),
            new(0x61, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            new(0x62, OpCode.KIL, (cpu, addr, value) => cpu.STP(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0x63, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            new(0x64, OpCode.DOP, (cpu, addr, value) => cpu.NOP(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x65, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x66, OpCode.ROR, (cpu, addr, value) => cpu.ROR(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x67, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0x68, OpCode.PLA, (cpu, addr, value) => cpu.PLA(addr, value), InstructionDecoders.DecodeStack, AddressingMode.Stack),
            new(0x69, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x6b, OpCode.ARR, (cpu, addr, value) => ((Cpu6502)cpu).ARR(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x6d, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0x6e, OpCode.ROR, (cpu, addr, value) => cpu.ROR(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0x6f, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),

            new(0x70, OpCode.BVS, (cpu, addr, value) => cpu.BVS(addr, value), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            new(0x71, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            new(0x72, OpCode.KIL, (cpu, addr, value) => cpu.STP(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0x73, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0x75, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0x77, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            new(0x78, OpCode.SEI, (cpu, addr, value) => cpu.SEI(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0x79, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            new(0x7a, OpCode.NOP, (cpu, addr, value) => cpu.NOP(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0x7b, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0x7d, OpCode.ADC, (cpu, addr, value) => ((Cpu6502)cpu).ADC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x7f, OpCode.RRA, (cpu, addr, value) => ((Cpu6502)cpu).RRA(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x83, OpCode.SAX, (cpu, addr, value) => ((Cpu6502)cpu).SAX(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0x87, OpCode.SAX, (cpu, addr, value) => ((Cpu6502)cpu).SAX(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0x8b, OpCode.ANE, (cpu, addr, value) => ((Cpu6502)cpu).ANE(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0x8f, OpCode.SAX, (cpu, addr, value) => ((Cpu6502)cpu).SAX(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            ...
            new(0x93, OpCode.SHA, (cpu, addr, value) => ((Cpu6502)cpu).SHA(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0x97, OpCode.SAX, (cpu, addr, value) => ((Cpu6502)cpu).SAX(addr, value), InstructionDecoders.DecodeZeroPageYIndexed, AddressingMode.ZeroPageYIndexed),
            ...
            new(0x9b, OpCode.TAS, (cpu, addr, value) => ((Cpu6502)cpu).TAS(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            new(0x9c, OpCode.SHY, (cpu, addr, value) => ((Cpu6502)cpu).SHY(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0x9e, OpCode.SHX, (cpu, addr, value) => ((Cpu6502)cpu).SHX(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            new(0x9f, OpCode.SHA, (cpu, addr, value) => ((Cpu6502)cpu).SHA(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xa3, OpCode.LAX, (cpu, addr, value) => ((Cpu6502)cpu).LAX(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0xa7, OpCode.LAX, (cpu, addr, value) => ((Cpu6502)cpu).LAX(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xab, OpCode.LXA, (cpu, addr, value) => ((Cpu6502)cpu).LXA(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0xaf, OpCode.LAX, (cpu, addr, value) => ((Cpu6502)cpu).LAX(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            ...
            new(0xb3, OpCode.LAX, (cpu, addr, value) => ((Cpu6502)cpu).LAX(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0xb7, OpCode.LAX, (cpu, addr, value) => ((Cpu6502)cpu).LAX(addr, value), InstructionDecoders.DecodeZeroPageYIndexed, AddressingMode.ZeroPageYIndexed),
            ...
            new(0xbb, OpCode.LAS, (cpu, addr, value) => ((Cpu6502)cpu).LAS(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xbf, OpCode.LAX, (cpu, addr, value) => ((Cpu6502)cpu).LAX(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xc3, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            ...
            new(0xc7, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            ...
            new(0xcb, OpCode.AXS, (cpu, addr, value) => ((Cpu6502)cpu).AXS(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            ...
            new(0xcf, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            ...
            new(0xd3, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0xd7, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0xdb, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xdf, OpCode.DCP, (cpu, addr, value) => ((Cpu6502)cpu).DCP(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),

            new(0xe0, OpCode.CPX, (cpu, addr, value) => cpu.CPX(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            new(0xe1, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            new(0xe2, OpCode.DOP, (cpu, addr, value) => cpu.NOP(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            new(0xe3, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeXIndexedIndirect, AddressingMode.XIndexedIndirect),
            new(0xe4, OpCode.CPX, (cpu, addr, value) => cpu.CPX(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe5, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe6, OpCode.INC, (cpu, addr, value) => cpu.INC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe7, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeZeroPage, AddressingMode.ZeroPage),
            new(0xe8, OpCode.INX, (cpu, addr, value) => cpu.INX(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xe9, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            new(0xea, OpCode.NOP, (cpu, addr, value) => cpu.NOP(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xeb, OpCode.USBC, (cpu, addr, value) => ((Cpu6502)cpu).USBC(addr, value), InstructionDecoders.DecodeImmediate, AddressingMode.Immediate),
            new(0xec, OpCode.CPX, (cpu, addr, value) => cpu.CPX(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xed, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xee, OpCode.INC, (cpu, addr, value) => cpu.INC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),
            new(0xef, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeAbsolute, AddressingMode.Absolute),

            new(0xf0, OpCode.BEQ, (cpu, addr, value) => cpu.BEQ(addr, value), InstructionDecoders.DecodeRelative, AddressingMode.Relative),
            new(0xf1, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            new(0xf2, OpCode.KIL, (cpu, addr, value) => cpu.STP(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xf3, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeIndirectYIndexed, AddressingMode.IndirectYIndexed),
            ...
            new(0xf5, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            ...
            new(0xf7, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeZeroPageXIndexed, AddressingMode.ZeroPageXIndexed),
            new(0xf8, OpCode.SED, (cpu, addr, value) => cpu.SED(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xf9, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            new(0xfa, OpCode.NOP, (cpu, addr, value) => cpu.NOP(addr, value), InstructionDecoders.DecodeImplicit, AddressingMode.Implicit),
            new(0xfb, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeAbsoluteYIndexed, AddressingMode.AbsoluteYIndexed),
            ...
            new(0xfd, OpCode.SBC, (cpu, addr, value) => ((Cpu6502)cpu).SBC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
            ...
            new(0xff, OpCode.ISC, (cpu, addr, value) => ((Cpu6502)cpu).ISC(addr, value), InstructionDecoders.DecodeAbsoluteXIndexed, AddressingMode.AbsoluteXIndexed),
        };
    }
}
